...
def make_polarity_features(data):
    ...
    first_sentence_sentiment_array = []
    ...
    for review in data:
        ...
        first_sentence_sentiment_array.append([first_sentence_sentiment])

    print("Finished making sentiment features.")
    return PSP_array, last_sentence_sentiment_array, first_sentence_sentiment_array
